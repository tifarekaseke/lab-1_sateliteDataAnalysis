...
echo "Top 10 countries with the highest temperature data" > "$output_file"
echo "" >> "$output_file"
...
# Add the title of the second table
echo "South Africa Data sorted by Highest to Lowest Humidity" >> "$output_file"
echo "" >> "$output_file"
